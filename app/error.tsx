...
// A basic error boundary that displays a user-friendly error page if something goes wrong.
// Users can contact support, return to the main page, or attempt to reset/refresh to resolve the issue.
